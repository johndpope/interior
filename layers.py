...
def conv(batch_input, out_channels, stride):
    with tf.variable_scope("conv"):
        ...
        filter = tf.get_variable("filter", [2, 2, in_channels, out_channels], dtype=tf.float32, initializer=tf.random_normal_initializer(0, 0.02))
...
def deconv(batch_input, out_channels):
    with tf.variable_scope("deconv"):
        ...
        filter = tf.get_variable("filter", [2, 2, out_channels, in_channels], dtype=tf.float32, initializer=tf.random_normal_initializer(0, 0.02))
